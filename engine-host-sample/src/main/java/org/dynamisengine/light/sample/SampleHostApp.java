...
import org.dynamisengine.light.api.validation.EngineConfigValidator;
import org.dynamisengine.light.api.validation.SceneValidator;
...
public final class SampleHostApp {
    ...
    private static void printResources(List<org.dynamisengine.light.api.resource.ResourceInfo> resources, String label) {
    ...
    private static void printOverlay(org.dynamisengine.light.api.runtime.EngineRuntime runtime, EngineFrameResult renderResult, SceneOptions options) {
