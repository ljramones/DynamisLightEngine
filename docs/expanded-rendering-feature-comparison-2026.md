...
| Anti-Aliasing | SMAA-lite + jitter-aware TAA temporal-history blend with per-pixel velocity reprojection in OpenGL and Vulkan (global camera-motion reprojection still layered for stability) | TAA | TSR/TAA | TAAU (+ upscalers) | TAA/MSAA |
