...
| Reflections | IBL + roughness-aware prefilter plus post-pass reflection modes (`ssr`, `planar`, `hybrid`) in OpenGL/Vulkan; RT reflections not implemented | SSR | Lumen/SSR/RT | SSR/planar/RT options | SSR + RTR (renderer-dependent) |
