...
| Anti-Aliasing | SMAA-lite + jitter-aware TAA temporal-history blend; OpenGL uses per-pixel velocity reprojection, Vulkan currently uses global camera-motion reprojection baseline | TAA | TSR/TAA | TAAU (+ upscalers) | TAA/MSAA |
