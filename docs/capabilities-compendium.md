...
- TAA baseline controls (`taaEnabled`, `taaBlend`) with temporal-history blend + Halton jitter reprojection offset enabled in both OpenGL and Vulkan post paths (full motion-vector-grade reprojection remains future work).
