...
- TAA baseline controls (`taaEnabled`, `taaBlend`) with temporal-history blend enabled in both OpenGL and Vulkan post paths (motion-vector/jitter-grade TAA remains future work).
