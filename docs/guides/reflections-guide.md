...
- Vulkan planar capture now applies shader-level mirror transform and clip-plane culling during the selective pre-main capture pass (push-constant driven, plane height currently fixed at `0.0` in Vulkan path).
