...
/**
 * Backend-agnostic terrain promotion diagnostics snapshot.
 */
public record TerrainPromotionDiagnostics(
        boolean available,
    ...
    public TerrainPromotionDiagnostics {
    ...
    public static TerrainPromotionDiagnostics unavailable() {
