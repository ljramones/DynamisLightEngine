...
import org.dynamisengine.light.impl.vulkan.runtime.mapper.VulkanEngineRuntimeSceneMapper;
...
final class VulkanRuntimeLifecycle {
    ...
    static void applySceneToContext(VulkanContext context, SceneLoadState state) throws EngineException {
        ...
        context.setPostProcessParameters(
                ...
                state.post().taaRenderScale(),
                state.post().reflectionsEnabled(),
                state.post().reflectionsMode(),
                state.post().reflectionsSsrStrength(),
    ...
    static RenderState render(
        ...
        return new RenderState(
                ...
                frame.cpuFrameMs(),
                frame.gpuFrameMs(),
                frame.planarCaptureGpuMs(),
                frame.gpuTimingSource(),
                frame.drawCalls(),
                frame.triangles(),
    ...
    static ShadowRefreshState refreshShadows(
            List<org.dynamisengine.light.api.scene.LightDesc> lights,
            QualityTier qualityTier,
            String shadowFilterPath,
            boolean shadowContactShadows,
            String shadowRtMode,
