...
public final class VulkanSwapchainResourceCoordinator {
    ...
    public static Allocation create(CreateInputs inputs) throws EngineException {
        ...
        return new Allocation(
                ...
                mainPipeline.bindlessSkinnedPipelineLayout(),
                mainPipeline.bindlessSkinnedGraphicsPipeline(),
                mainPipeline.bindlessMorphPipelineLayout(),
                mainPipeline.bindlessMorphGraphicsPipeline(),
                mainPipeline.bindlessSkinnedMorphPipelineLayout(),
                mainPipeline.bindlessSkinnedMorphGraphicsPipeline(),
                mainPipeline.bindlessInstancedPipelineLayout(),
                mainPipeline.bindlessInstancedGraphicsPipeline(),
