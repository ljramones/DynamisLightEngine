...
import org.dynamisengine.light.impl.vulkan.command.VulkanCullingComputePass;
import org.dynamisengine.light.impl.vulkan.command.VulkanDrawMetaBuffer;
import org.dynamisengine.light.impl.vulkan.command.VulkanIndirectDrawBuffer;
import org.dynamisengine.light.impl.vulkan.descriptor.VulkanTextureDescriptorSetCoordinator;
import org.dynamisengine.light.impl.vulkan.lifecycle.VulkanLifecycleOrchestrator;
...
import org.dynamisengine.light.impl.vulkan.profile.VulkanContextDiagnosticsCoordinator;
import org.dynamisengine.light.impl.vulkan.profile.VulkanContextProfileCoordinator;
...
import org.dynamisengine.light.impl.vulkan.scene.VulkanSceneRuntimeCoordinator;
import org.dynamisengine.light.impl.vulkan.scene.VulkanSceneMeshCoordinator;
import org.dynamisengine.light.impl.vulkan.scene.VulkanSceneMeshLifecycle;
import org.dynamisengine.light.impl.vulkan.scene.VulkanReflectionProbeRuntimeCoordinator;
import org.dynamisengine.light.impl.vulkan.scene.VulkanReflectionProbeTextureCoordinator;
import org.dynamisengine.light.impl.vulkan.scene.VulkanSceneSetPlanner;
import org.dynamisengine.light.impl.vulkan.scene.VulkanSceneTextureRuntimeCoordinator;
import org.dynamisengine.light.impl.vulkan.scene.VulkanSceneTextureCoordinator;
import org.dynamisengine.light.impl.vulkan.sky.VulkanSkyRuntimeBridge;
import org.dynamisengine.light.impl.vulkan.shadow.VulkanShadowMatrixStateCoordinator;
import org.dynamisengine.light.impl.vulkan.state.VulkanFrameUploadStats;
import org.dynamisengine.light.impl.vulkan.state.VulkanIblState;
import org.dynamisengine.light.impl.vulkan.state.VulkanRenderParameterMutator;
...
import org.dynamisengine.light.impl.vulkan.state.VulkanTemporalAaCoordinator;
import org.dynamisengine.light.impl.vulkan.swapchain.VulkanSwapchainRecreateCoordinator;
import org.dynamisengine.light.impl.vulkan.swapchain.VulkanSwapchainTimestampRuntimeHelper;
import org.dynamisengine.light.impl.vulkan.texture.VulkanTexturePixelLoader;
import org.dynamisengine.light.impl.vulkan.uniform.VulkanFrameUniformCoordinator;
import org.dynamisengine.light.impl.vulkan.uniform.VulkanGlobalSceneBuildRequestFactory;
import org.dynamisengine.light.impl.vulkan.uniform.VulkanGlobalSceneUniformCoordinator;
import org.dynamisengine.light.impl.vulkan.uniform.VulkanUniformUploadCoordinator;
import org.dynamisengine.light.impl.vulkan.uniform.VulkanUploadStateTracker;
import org.dynamisengine.light.impl.vulkan.vfx.VulkanVfxDepthSamplerBridge;
import org.dynamisengine.light.impl.vulkan.vfx.VulkanVfxGBufferBridge;
import org.dynamisengine.light.impl.vulkan.vfx.VulkanVfxIntegration;
import org.dynamisengine.light.impl.vulkan.vfx.VfxRenderPhaseTracker;
...
public final class VulkanContext {
    ...
    private RenderFeatureMode pipelineSkyModeOverride;
    ...
    void setPipelineSkyModeOverride(String modeId) { pipelineSkyModeOverride = (modeId == null || modeId.isBlank()) ? null : new RenderFeatureMode(modeId); }
