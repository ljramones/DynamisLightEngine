...
import org.dynamisengine.light.impl.vulkan.shadow.VulkanShadowFrameWarningFlow;
import org.dynamisengine.light.impl.vulkan.runtime.warning.VulkanRuntimeWarningResets;
import org.dynamisengine.light.impl.vulkan.runtime.warning.VulkanRuntimeWarningPolicy;
import org.dynamisengine.light.impl.vulkan.shadow.VulkanShadowBackendDiagnosticsBridge;
import org.dynamisengine.light.impl.vulkan.shadow.VulkanShadowContextBindings;
import org.dynamisengine.light.impl.vulkan.runtime.upscale.VulkanExternalUpscalerDecider;
...
import org.dynamisengine.light.impl.vulkan.state.VulkanTelemetryStateBinder;
import org.dynamisengine.light.impl.vulkan.runtime.config.AaMode;
import org.dynamisengine.light.impl.vulkan.runtime.config.AaPreset;
import org.dynamisengine.light.impl.vulkan.runtime.config.ReflectionProfile;
import org.dynamisengine.light.impl.vulkan.runtime.config.TsrControls;
import org.dynamisengine.light.impl.vulkan.runtime.config.UpscalerMode;
import org.dynamisengine.light.impl.vulkan.runtime.config.UpscalerQuality;
import org.dynamisengine.light.impl.vulkan.runtime.config.VulkanRuntimeOptionParsing;
import org.dynamisengine.light.impl.vulkan.runtime.config.VulkanRuntimeOptions;
import org.dynamisengine.light.impl.vulkan.reflection.*;
import org.dynamisengine.light.impl.vulkan.reflection.VulkanReflectionTelemetryDefaults;
import org.dynamisengine.light.impl.vulkan.shadow.VulkanShadowTelemetryDefaults;
...
import org.dynamisengine.light.api.event.ReflectionAdaptiveTelemetryEvent;
import org.dynamisengine.light.api.config.QualityTier;
import org.dynamisengine.light.api.runtime.AaPostCapabilityDiagnostics;
import org.dynamisengine.light.api.runtime.AaTemporalPromotionDiagnostics;
import org.dynamisengine.light.api.runtime.AaUpscalePromotionDiagnostics;
import org.dynamisengine.light.api.runtime.AaMsaaPromotionDiagnostics;
import org.dynamisengine.light.api.runtime.AaQualityPromotionDiagnostics;
...
import org.dynamisengine.light.api.runtime.LightingBudgetDiagnostics;
import org.dynamisengine.light.api.runtime.LightingCapabilityDiagnostics;
import org.dynamisengine.light.api.runtime.LightingEmissiveDiagnostics;
import org.dynamisengine.light.api.runtime.LightingPromotionDiagnostics;
import org.dynamisengine.light.api.runtime.LightingAdvancedDiagnostics;
import org.dynamisengine.light.api.runtime.PbrCapabilityDiagnostics;
import org.dynamisengine.light.api.runtime.PbrPromotionDiagnostics;
import org.dynamisengine.light.api.runtime.PostCorePromotionDiagnostics;
...
import org.dynamisengine.light.api.runtime.RtCrossCutDiagnostics;
import org.dynamisengine.light.api.runtime.SkyCapabilityDiagnostics;
import org.dynamisengine.light.api.runtime.SkyPromotionDiagnostics;
...
import org.dynamisengine.light.api.runtime.ShadowCapabilityDiagnostics;
import org.dynamisengine.light.api.runtime.ShadowCacheDiagnostics;
import org.dynamisengine.light.api.runtime.ShadowCadenceDiagnostics;
import org.dynamisengine.light.api.runtime.ShadowPointBudgetDiagnostics;
import org.dynamisengine.light.api.runtime.ShadowRtDiagnostics;
import org.dynamisengine.light.api.runtime.ShadowHybridDiagnostics;
import org.dynamisengine.light.api.runtime.ShadowSpotProjectedDiagnostics;
import org.dynamisengine.light.api.runtime.ShadowTransparentReceiverDiagnostics;
import org.dynamisengine.light.api.runtime.ShadowExtendedModeDiagnostics;
import org.dynamisengine.light.api.runtime.ShadowTopologyDiagnostics;
import org.dynamisengine.light.api.runtime.ShadowPhaseAPromotionDiagnostics;
import org.dynamisengine.light.api.runtime.ShadowPhaseDPromotionDiagnostics;
...
import org.dynamisengine.light.api.scene.ReflectionOverrideMode;
...
import org.dynamisengine.light.impl.vulkan.asset.VulkanGltfMeshParser;
...
import org.dynamisengine.light.impl.vulkan.warning.aa.VulkanAaPostWarningEmitter;
import org.dynamisengine.light.impl.vulkan.warning.aa.VulkanAaTemporalMaterialWarningEmitter;
import org.dynamisengine.light.impl.vulkan.warning.aa.VulkanAaMsaaWarningEmitter;
import org.dynamisengine.light.impl.vulkan.warning.aa.VulkanAaQualityWarningEmitter;
import org.dynamisengine.light.impl.vulkan.warning.aa.VulkanAaTemporalRuntimeState;
import org.dynamisengine.light.impl.vulkan.warning.aa.VulkanAaTemporalWarningEmitter;
import org.dynamisengine.light.impl.vulkan.warning.aa.VulkanAaUpscaleWarningEmitter;
import org.dynamisengine.light.impl.vulkan.gi.VulkanGiCapabilityRuntimeState;
import org.dynamisengine.light.impl.vulkan.geometry.VulkanGeometryCapabilityRuntimeState;
import org.dynamisengine.light.impl.vulkan.lighting.VulkanLightingCapabilityRuntimeState;
import org.dynamisengine.light.impl.vulkan.pbr.VulkanPbrCapabilityRuntimeState;
import org.dynamisengine.light.impl.vulkan.post.VulkanPostCoreRuntimeState;
import org.dynamisengine.light.impl.vulkan.post.VulkanPostCinematicRuntimeState;
import org.dynamisengine.light.impl.vulkan.rt.VulkanRtCapabilityRuntimeState;
import org.dynamisengine.light.impl.vulkan.rt.VulkanRtCrossCutRuntimeState;
import org.dynamisengine.light.impl.vulkan.sky.VulkanSkyCapabilityRuntimeState;
import org.dynamisengine.light.impl.vulkan.vfx.VulkanVfxCapabilityRuntimeState;
import org.dynamisengine.light.impl.vulkan.water.VulkanWaterCapabilityRuntimeState;
import org.dynamisengine.light.impl.vulkan.terrain.VulkanTerrainCapabilityRuntimeState;
import org.dynamisengine.light.impl.vulkan.model.VulkanSceneMeshData;
import org.dynamisengine.light.impl.vulkan.profile.FrameResourceProfile;
import org.dynamisengine.light.impl.vulkan.profile.PostProcessPipelineProfile;
import org.dynamisengine.light.impl.vulkan.profile.SceneReuseStats;
import org.dynamisengine.light.impl.vulkan.profile.ShadowCascadeProfile;
import org.dynamisengine.light.impl.vulkan.profile.VulkanFrameMetrics;
...
public final class VulkanEngineRuntime extends AbstractEngineRuntime {
    ...
    private final VulkanGeometryCapabilityRuntimeState geometryCapabilityState = new VulkanGeometryCapabilityRuntimeState();
    ...
    private final VulkanVfxCapabilityRuntimeState vfxCapabilityState = new VulkanVfxCapabilityRuntimeState();
    private final VulkanWaterCapabilityRuntimeState waterCapabilityState = new VulkanWaterCapabilityRuntimeState();
    ...
    protected void onInitialize(EngineConfig config) throws EngineException {
        ...
        vfxCapabilityState.applyBackendOptions(safeBackendOptions);
        waterCapabilityState.applyBackendOptions(safeBackendOptions);
        ...
        vfxCapabilityState.applyProfileDefaults(safeBackendOptions, resolvedQualityTier);
    ...
    @Override
    protected org.dynamisengine.light.api.runtime.ReflectionAdaptiveTrendSloDiagnostics backendReflectionAdaptiveTrendSloDiagnostics() {
        ReflectionAdaptiveTrendSloDiagnostics diagnostics = debugReflectionAdaptiveTrendSloDiagnostics();
        return new org.dynamisengine.light.api.runtime.ReflectionAdaptiveTrendSloDiagnostics(
                diagnostics.status(),
                diagnostics.reason(),
                diagnostics.failed(),
    ...
    protected GiCapabilityDiagnostics backendGiCapabilityDiagnostics() {
        return giCapabilityState.diagnostics();
    }

    @Override
    protected GiPromotionDiagnostics backendGiPromotionDiagnostics() {
        return giCapabilityState.promotionDiagnostics();
    }
    @Override
    ...
    @Override
    protected GeometryCapabilityDiagnostics backendGeometryCapabilityDiagnostics() { return geometryCapabilityState.diagnostics(); }
    @Override
    protected GeometryPromotionDiagnostics backendGeometryPromotionDiagnostics() { return geometryCapabilityState.promotionDiagnostics(); }
    @Override
    protected VfxCapabilityDiagnostics backendVfxCapabilityDiagnostics() { return vfxCapabilityState.diagnostics(); }
    @Override
    protected VfxPromotionDiagnostics backendVfxPromotionDiagnostics() { return vfxCapabilityState.promotionDiagnostics(); }
    @Override
    protected WaterCapabilityDiagnostics backendWaterCapabilityDiagnostics() { return waterCapabilityState.diagnostics(); }
    @Override
    protected WaterPromotionDiagnostics backendWaterPromotionDiagnostics() { return waterCapabilityState.promotionDiagnostics(); }
    @Override
    protected TerrainCapabilityDiagnostics backendTerrainCapabilityDiagnostics() { return terrainCapabilityState.diagnostics(); }
    @Override
    protected TerrainPromotionDiagnostics backendTerrainPromotionDiagnostics() { return terrainCapabilityState.promotionDiagnostics(); }
    @Override
    ...
    protected java.util.List<EngineWarning> frameWarnings() {
        ...
        vfxCapabilityState.emitFrameWarnings(warnings);
        waterCapabilityState.emitFrameWarnings(warnings);
        terrainCapabilityState.emitFrameWarnings(warnings);
        postCoreState.emitFrameWarnings(
                currentPost,
                currentFog,
                aaPostActiveCapabilitiesLastFrame.contains("vulkan.post.sharpening"),
