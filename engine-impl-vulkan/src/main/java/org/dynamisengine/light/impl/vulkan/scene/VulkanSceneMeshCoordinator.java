...
public final class VulkanSceneMeshCoordinator {
    ...
    public static SetSceneResult setSceneMeshes(SetSceneRequest in) throws EngineException {
        ...
        List<org.dynamisengine.light.impl.vulkan.model.VulkanSceneMeshData> safe = plan.sceneMeshes();
    ...
    public static void createTextureDescriptorSets(TextureDescriptorRequest in) throws EngineException {
        org.dynamisengine.light.impl.vulkan.model.VulkanGpuTexture iblIrradianceTexture = in.iblState().irradianceTexture;
        org.dynamisengine.light.impl.vulkan.model.VulkanGpuTexture iblRadianceTexture = in.iblState().radianceTexture;
        org.dynamisengine.light.impl.vulkan.model.VulkanGpuTexture iblBrdfLutTexture = in.iblState().brdfLutTexture;
        org.dynamisengine.light.impl.vulkan.model.VulkanGpuTexture probeRadianceTexture = in.iblState().probeRadianceTexture;
        if ((!in.sceneResources().gpuMeshes.isEmpty())
                && (iblIrradianceTexture == null || iblRadianceTexture == null || iblBrdfLutTexture == null)) {
            org.dynamisengine.light.impl.vulkan.model.VulkanGpuTexture fallback = in.sceneResources().gpuMeshes.get(0).albedoTexture;
    ...
    public record SetSceneRequest(
            List<org.dynamisengine.light.impl.vulkan.model.VulkanSceneMeshData> sceneMeshes,
