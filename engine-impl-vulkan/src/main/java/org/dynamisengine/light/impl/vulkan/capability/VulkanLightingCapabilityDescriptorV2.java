...
public final class VulkanLightingCapabilityDescriptorV2 implements RenderFeatureCapabilityV2 {
    ...
    public List<RenderSchedulerDeclaration> schedulers(RenderFeatureMode mode) {
        return List.of(new RenderSchedulerDeclaration(
                ...
                List.of(
                        new org.dynamisengine.light.spi.render.RenderBudgetParameter("maxLocalLightsPerFrame", "8"),
                        new org.dynamisengine.light.spi.render.RenderBudgetParameter("maxEmissiveMeshLightsPerFrame", "32")
                ),
                true,
                true
        ));
    ...
    public RenderTelemetryDeclaration telemetry(RenderFeatureMode mode) {
        return new RenderTelemetryDeclaration(
                List.of(
                        ...
                        "LIGHTING_AREA_APPROX_POLICY",
                        "LIGHTING_AREA_APPROX_ENVELOPE_BREACH",
                        "LIGHTING_AREA_APPROX_PROMOTION_READY",
                        "LIGHTING_IES_PROFILES_POLICY",
                        "LIGHTING_IES_PROFILES_ENVELOPE_BREACH",
                        "LIGHTING_IES_PROFILES_PROMOTION_READY",
                        "LIGHTING_COOKIES_POLICY",
                        "LIGHTING_COOKIES_ENVELOPE_BREACH",
                        "LIGHTING_COOKIES_PROMOTION_READY",
                        "LIGHTING_VOLUMETRIC_SHAFTS_POLICY",
                        "LIGHTING_VOLUMETRIC_SHAFTS_ENVELOPE_BREACH",
                        "LIGHTING_VOLUMETRIC_SHAFTS_PROMOTION_READY",
                        "LIGHTING_CLUSTERING_POLICY",
                        "LIGHTING_CLUSTERING_ENVELOPE_BREACH",
                        "LIGHTING_CLUSTERING_PROMOTION_READY",
                        "LIGHTING_LIGHT_LAYERS_POLICY",
                        "LIGHTING_LIGHT_LAYERS_ENVELOPE_BREACH",
                        "LIGHTING_LIGHT_LAYERS_PROMOTION_READY",
