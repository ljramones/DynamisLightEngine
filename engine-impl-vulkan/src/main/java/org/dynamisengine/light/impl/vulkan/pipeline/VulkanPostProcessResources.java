...
import org.dynamisengine.light.impl.vulkan.descriptor.VulkanComposedDescriptorBinding;
    ...
    private static long createPostDescriptorSetLayout(
        ...
        if (set0.isEmpty()) {
            set0 = java.util.List.of(
                    new VulkanComposedDescriptorBinding(0, 0, RenderDescriptorType.COMBINED_IMAGE_SAMPLER, org.dynamisengine.light.spi.render.RenderBindingFrequency.PER_PASS, false, java.util.List.of("fallback")),
                    new VulkanComposedDescriptorBinding(0, 1, RenderDescriptorType.COMBINED_IMAGE_SAMPLER, org.dynamisengine.light.spi.render.RenderBindingFrequency.PER_PASS, false, java.util.List.of("fallback")),
                    new VulkanComposedDescriptorBinding(0, 2, RenderDescriptorType.COMBINED_IMAGE_SAMPLER, org.dynamisengine.light.spi.render.RenderBindingFrequency.PER_PASS, false, java.util.List.of("fallback")),
                    new VulkanComposedDescriptorBinding(0, 3, RenderDescriptorType.COMBINED_IMAGE_SAMPLER, org.dynamisengine.light.spi.render.RenderBindingFrequency.PER_PASS, false, java.util.List.of("fallback")),
                    new VulkanComposedDescriptorBinding(0, 4, RenderDescriptorType.COMBINED_IMAGE_SAMPLER, org.dynamisengine.light.spi.render.RenderBindingFrequency.PER_PASS, false, java.util.List.of("fallback"))
            );
        }
