...
public final class VulkanRtCapabilityDescriptorV2 implements RenderFeatureCapabilityV2 {
    ...
    public List<RenderSchedulerDeclaration> schedulers(RenderFeatureMode mode) {
        return List.of(new RenderSchedulerDeclaration(
                ...
                List.of(
                        new org.dynamisengine.light.spi.render.RenderBudgetParameter("rtAoRayCount", "8"),
                        new org.dynamisengine.light.spi.render.RenderBudgetParameter("rtCausticsRayCount", "4"),
                        new org.dynamisengine.light.spi.render.RenderBudgetParameter("rtBvhRefitPerFrame", "1")
                ),
                false,
                true
        ));
