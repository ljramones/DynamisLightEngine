package org.dynamisengine.light.impl.vulkan.warning.aa;
...
public final class VulkanAaTemporalRuntimeState {
    ...
    public VulkanAaUpscaleWarningEmitter.Result emitUpscale(
            org.dynamisengine.light.impl.vulkan.runtime.config.AaMode aaMode,
            double renderScale,
    ...
    public VulkanAaMsaaWarningEmitter.Result emitMsaa(
            org.dynamisengine.light.impl.vulkan.runtime.config.AaMode aaMode,
            java.util.List<org.dynamisengine.light.api.scene.MaterialDesc> materials,
            boolean smaaEnabled,
            boolean temporalPathActive
    ) {
