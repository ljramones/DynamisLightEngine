...
public final class VulkanMorphVertexShaderSource {
    private VulkanMorphVertexShaderSource() {
    }
    ...
    public static String mainVertex() {
        return """
                ...
                layout(set = 2, binding = 3) readonly buffer MorphDeltas {
                    float deltas[];
                } morphBuffer;
                layout(set = 2, binding = 4) uniform MorphWeights {
                    float weights[256];
                } morphWeights;
