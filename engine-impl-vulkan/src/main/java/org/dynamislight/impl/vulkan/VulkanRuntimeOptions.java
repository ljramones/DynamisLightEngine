...
final class VulkanRuntimeOptions {
    ...
    static Parsed parse(Map<String, String> options, int defaultMeshGeometryCacheEntries) {
        ...
        return new Parsed(
                ...
                parseDoubleOption(safe, "vulkan.reflections.overrideProbeOnlyRatioWarnMax", 0.75, 0.0, 1.0),
                parseDoubleOption(safe, "vulkan.reflections.overrideSsrOnlyRatioWarnMax", 0.75, 0.0, 1.0),
                parseIntOption(safe, "vulkan.reflections.overrideOtherWarnMax", 0, 0, 10000),
                parseIntOption(safe, "vulkan.reflections.overrideWarnMinFrames", 3, 1, 600),
                parseIntOption(safe, "vulkan.reflections.overrideWarnCooldownFrames", 120, 0, 10000),
                parseDoubleOption(safe, "vulkan.reflections.contactHardeningMinSsrStrength", 0.35, 0.0, 1.0),
                parseDoubleOption(safe, "vulkan.reflections.contactHardeningMinSsrMaxRoughness", 0.55, 0.0, 1.0),
                parseIntOption(safe, "vulkan.reflections.contactHardeningWarnMinFrames", 3, 1, 600),
                parseIntOption(safe, "vulkan.reflections.contactHardeningWarnCooldownFrames", 120, 0, 10000),
                parseDoubleOption(safe, "vulkan.reflections.probeQualityBoxProjectionMinRatio", 0.60, 0.0, 1.0),
                parseIntOption(safe, "vulkan.reflections.probeQualityInvalidBlendDistanceWarnMax", 0, 0, 10000),
                parseDoubleOption(safe, "vulkan.reflections.probeQualityOverlapCoverageWarnMin", 0.12, 0.0, 1.0),
                ...
                parseBoolean(safe, "vulkan.reflections.rtRequireActive", false),
                parseBoolean(safe, "vulkan.reflections.rtRequireMultiBounce", false),
                parseBoolean(safe, "vulkan.reflections.rtRequireDedicatedPipeline", false),
                parseBoolean(safe, "vulkan.reflections.rtDedicatedPipelineEnabled", false),
                ...
                parseDoubleOption(safe, "vulkan.reflections.rtPerfMaxGpuMsLow", 1.6, 0.0, 1000.0),
                parseDoubleOption(safe, "vulkan.reflections.rtPerfMaxGpuMsMedium", 2.6, 0.0, 1000.0),
                parseDoubleOption(safe, "vulkan.reflections.rtPerfMaxGpuMsHigh", 3.6, 0.0, 1000.0),
                parseDoubleOption(safe, "vulkan.reflections.rtPerfMaxGpuMsUltra", 4.8, 0.0, 1000.0),
                parseIntOption(safe, "vulkan.reflections.rtPerfWarnMinFrames", 3, 1, 600),
                parseIntOption(safe, "vulkan.reflections.rtPerfWarnCooldownFrames", 120, 0, 10000),
                parseDoubleOption(safe, "vulkan.reflections.rtHybridProbeShareWarnMax", 0.70, 0.0, 1.0),
                parseIntOption(safe, "vulkan.reflections.rtHybridWarnMinFrames", 3, 1, 600),
                parseIntOption(safe, "vulkan.reflections.rtHybridWarnCooldownFrames", 120, 0, 10000),
                parseDoubleOption(safe, "vulkan.reflections.rtDenoiseSpatialVarianceWarnMax", 0.45, 0.0, 1.0),
                parseDoubleOption(safe, "vulkan.reflections.rtDenoiseTemporalLagWarnMax", 0.35, 0.0, 1.0),
                parseIntOption(safe, "vulkan.reflections.rtDenoiseWarnMinFrames", 3, 1, 600),
                parseIntOption(safe, "vulkan.reflections.rtDenoiseWarnCooldownFrames", 120, 0, 10000),
                parseDoubleOption(safe, "vulkan.reflections.rtAsBuildGpuMsWarnMax", 1.2, 0.0, 1000.0),
                parseDoubleOption(safe, "vulkan.reflections.rtAsMemoryBudgetMb", 64.0, 1.0, 4096.0),
                parseDoubleOption(safe, "vulkan.reflections.transparencyCandidateReactiveMin", 0.35, 0.0, 1.0),
                parseDoubleOption(safe, "vulkan.reflections.transparencyProbeOnlyRatioWarnMax", 0.65, 0.0, 1.0),
                parseIntOption(safe, "vulkan.reflections.transparencyWarnMinFrames", 3, 1, 600),
                parseIntOption(safe, "vulkan.reflections.transparencyWarnCooldownFrames", 120, 0, 10000),
                ...
                parseIntOption(safe, "vulkan.reflections.probeStreamingWarnMinFrames", 3, 1, 600),
                parseIntOption(safe, "vulkan.reflections.probeStreamingWarnCooldownFrames", 120, 0, 10000),
                parseDoubleOption(safe, "vulkan.reflections.probeStreamingMissRatioWarnMax", 0.35, 0.0, 1.0),
                parseDoubleOption(safe, "vulkan.reflections.probeStreamingDeferredRatioWarnMax", 0.55, 0.0, 1.0),
                parseDoubleOption(safe, "vulkan.reflections.probeStreamingLodSkewWarnMax", 0.70, 0.0, 1.0),
                parseDoubleOption(safe, "vulkan.reflections.probeStreamingMemoryBudgetMb", 48.0, 1.0, 4096.0),
                ...
                parseDoubleOption(safe, "vulkan.shadow.cadenceWarnDeferredRatioMax", 0.55, 0.0, 1.0),
                parseIntOption(safe, "vulkan.shadow.cadenceWarnMinFrames", 3, 1, 600),
                parseIntOption(safe, "vulkan.shadow.cadenceWarnCooldownFrames", 120, 0, 10000),
                ...
                parseDoubleOption(safe, "vulkan.shadow.rtDenoiseWarnMin", 0.45, 0.0, 1.0),
                parseIntOption(safe, "vulkan.shadow.rtSampleWarnMin", 2, 1, 16),
                parseDoubleOption(safe, "vulkan.shadow.rtPerfMaxGpuMsLow", 1.2, 0.0, 1000.0),
                parseDoubleOption(safe, "vulkan.shadow.rtPerfMaxGpuMsMedium", 2.0, 0.0, 1000.0),
                parseDoubleOption(safe, "vulkan.shadow.rtPerfMaxGpuMsHigh", 2.8, 0.0, 1000.0),
