...
public final class VulkanBindlessStaticVertexShaderSource {
    private VulkanBindlessStaticVertexShaderSource() {
    }
    ...
    public static String mainVertex() {
        return """
                ...
                void main() {
                    DrawMeta meta = drawMeta.entries[gl_DrawID];
                    ...
                    if (meta.materialIndex == 0xFFFFFFFFu) {
                        // Keep draw metadata read side-effecting until material bindless routing lands.
                        vHeight += 0.0;
                    }
                }
                """;
