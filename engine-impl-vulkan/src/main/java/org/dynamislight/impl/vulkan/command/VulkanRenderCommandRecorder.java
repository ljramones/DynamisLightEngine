...
public final class VulkanRenderCommandRecorder {
    ...
    public static void recordShadowAndMainPasses(
        ...
        recordShadowPasses(
                ...
                new ShadowPassInputs(
                        ...
                        in.indirectInstancedOffsetBytes(),
        ...
        recordPlanarReflectionPass(
                ...
                new PlanarReflectionPassInputs(
                        ...
                        in.indirectSkinnedOffsetBytes(),
                        in.indirectSkinnedMorphOffsetBytes(),
                        in.indirectInstancedOffsetBytes(),
                        in.indirectStaticMaxDraws(),
                        in.indirectMorphMaxDraws(),
                        in.indirectSkinnedMaxDraws(),
                        in.indirectSkinnedMorphMaxDraws(),
                        in.indirectInstancedMaxDraws(),
                        in.bindlessActive(),
                        in.bindlessDescriptorSet(),
                        in.frameDescriptorSet(),
    ...
    public record ShadowPassInputs(
            ...
            int indirectInstancedOffsetBytes,
            int indirectInstancedMaxDraws,
    ...
    public record MainPassInputs(
            ...
            int indirectSkinnedOffsetBytes,
            int indirectSkinnedMorphOffsetBytes,
            int indirectInstancedOffsetBytes,
            int indirectStaticMaxDraws,
            int indirectMorphMaxDraws,
            int indirectSkinnedMaxDraws,
            int indirectSkinnedMorphMaxDraws,
            int indirectInstancedMaxDraws,
            boolean bindlessActive,
            long bindlessDescriptorSet,
            long frameDescriptorSet,
