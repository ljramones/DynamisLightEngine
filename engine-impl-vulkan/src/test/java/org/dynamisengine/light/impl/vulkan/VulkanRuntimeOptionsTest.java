    ...
    void parseShadowSchedulerOverrides() {
        VulkanRuntimeOptions.Parsed parsed = VulkanRuntimeOptions.parse(
                Map.ofEntries(
                        ...
                        Map.entry("vulkan.shadow.cacheChurnWarnMax", "0.29"),
        ...
        assertEquals(0.29, parsed.shadowCacheChurnWarnMax());
        ...
        assertEquals(true, parsed.shadowTransparentReceiversEnabled());
    ...
    void parseShadowSchedulerOverridesFallbackToBounds() {
        VulkanRuntimeOptions.Parsed parsed = VulkanRuntimeOptions.parse(
                Map.ofEntries(
                        ...
                        Map.entry("vulkan.shadow.cacheChurnWarnMax", "9.0"),
        ...
        assertEquals(1.0, parsed.shadowCacheChurnWarnMax());
        ...
        assertEquals(false, parsed.shadowTransparentReceiversEnabled());
